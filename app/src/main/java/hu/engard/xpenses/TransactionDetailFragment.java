...
import hu.engard.xpenses.dummy.DummyContent;
...
public class TransactionDetailFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments().containsKey(ARG_ITEM_ID)) {
			...
			mItem = TransDao.find(getArguments().getLong(ARG_ITEM_ID));
		}
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (mItem != null) {
			((TextView) rootView.findViewById(R.id.transaction_amount))
			.setText(mItem.getAmount().toString());
			((TextView) rootView.findViewById(R.id.transaction_comment))
			.setText(mItem.getComment());
		}
